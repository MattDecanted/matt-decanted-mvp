...
type Round = {
  ...
  locked_vintage: string | null;      // (renamed in UI to Round Defaults)
      ...
      <form onSubmit={saveRound} className="space-y-5">
        ...
        {!creating && (
          <div className="text-xs text-gray-500 -mb-2">
            ...
            <button
              type="button"
              className="ml-2 inline-flex items-center gap-1 px-2 py-1 border rounded text-blue-700"
        ...
        <div className="rounded-lg border p-4">
          ...
          <p className="text-xs text-gray-600 mb-3">
            These are the canonical answers you’ll reveal for this round (vintage / variety / region / style).
            Players still answer via questions; these are used for the reveal and as defaults if you skip a question.
          </p>
...
function RoundQuestions({ roundId, locale }: { roundId: string; locale: string }) {
  ...
  return (
    <div className="mt-8 p-6 bg-white rounded-xl shadow space-y-4">
      ...
      {/* Inline editor (no nested modal flicker) */}
      {editing && (
        <QuestionFormInline
          key={editing.id || "new"}
          record={editing}
    ...
    <div className="border rounded-xl p-4">
      ...
      <form onSubmit={save} className="space-y-4">
        ...
        <div className="flex gap-3">
          ...
          <button type="button" onClick={onCancel} className="flex-1 border px-4 py-2 rounded-lg">
            Cancel
          </button>
        </div>
      </form>
...
/** Modal with z-index + click shielding (used only for RoundEditor) */
function Modal({
  title,
  children,
  onClose,
  ...
  return (
    <div className="fixed inset-0" style={{ zIndex: z }}>
      ...
      <div
        ...
        // shield clicks so overlay never receives them
